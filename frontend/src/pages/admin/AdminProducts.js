...
function AdminProducts() {
  ...
  useEffect(() => {
    ...
    const result = await Swal.fire({
      title: `Are you sure you want to delete ${item.prod_name}?`,
    ...
    if (result.isConfirmed) {
      try {
        const response = await axios.delete(`${baseURL}delete-product/${item.encProdId}`);
            ...
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center">
                ...
                <div className="ml-auto">
                  <button type="button" className="btn btn-outline-primary btn-sm" onClick={handleAddProduct}>Add Product</button>
                </div>
              </div>
