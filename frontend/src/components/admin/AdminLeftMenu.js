...
function AdminLeftMenu() {
  ...
  <a href="index3.html" className="brand-link">
    <img src="/AdminLTE/dist/img/AdminLTELogo.png" alt="" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
    <span className="brand-text font-weight-light">Dynamic Website</span>
  </a>
  {/* Sidebar */}
  <div className="sidebar">
    ...
    <nav className="mt-2">
      <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li className="nav-item">
          <Link to="/admin/nav-menu" className="nav-link">
