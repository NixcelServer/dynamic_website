    ...
    public function up()
    {
        Schema::create('tbl_cmp_desc', function (Blueprint $table) {
           ...
           // $table->unsignedBigInteger('tbl_cmp_dtls_id'); // Foreign key to the company details table
            $table->binary('cmp_desc')->nullable(); // BLOB column for storing company description
            $table->string('show_status')->nullable(); // Show status
            ...
            $table->string('flag', 7)->default('show'); // Flag
