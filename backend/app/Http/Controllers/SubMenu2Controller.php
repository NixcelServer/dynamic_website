    ...
    public function createSubMenu2(Request $request)
{
    ...
    $submenu1Link = SubMenu1::where('tbl_n_sub_menu_1_id', $subMenu1Id)->value('link'); // Corrected column name
    ...
    $subMenu2->link = $submenu1Link . '/submenu2' ; // Added '/' to separate the sub-menu name
